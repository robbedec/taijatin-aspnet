    ...
    public class ApplicationDataInitializer
    {
        ...
        public async Task InitializeData()
        {
            ...
            if (_dbContext.Database.EnsureCreated())
            {
                ...
                //Comments
                // var comment1 = new Comment { CommentText = "Kei interessant om te zien hoe hogere graden dit kunnen. Ik hoop dat we het snel zelf leren!", Member = member1, CourseModuleId = 3 };
                // var comment2 = new Comment { CommentText = "Heel boeiende eerste les. Ik kijk uit naar meer.", Member = member6, CourseModuleId = 3 };
                ...
                // var comment5 = new Comment { CommentText = "Wat zijn de beenworpen lastig. Ik hoop dat ik ze snel onder de knie heb...", Member = member7, CourseModuleId = 3 };
